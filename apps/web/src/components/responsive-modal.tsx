// From https://shadcnui-expansions.typeart.cc/docs/responsive-modal
"use client";
...
const ResponsiveModalVariants = cva(
  cn(
    "fixed z-1000 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 overflow-y-auto",
...
interface ResponsiveModalContentProperties
  extends React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>,
    VariantProps<typeof ResponsiveModalVariants> {}

const ResponsiveModalContent = React.forwardRef<
  React.ComponentRef<typeof DialogPrimitive.Content>,
  ResponsiveModalContentProperties
>(({ side = "bottom", className, children, ...properties }, reference) => (
