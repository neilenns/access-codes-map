/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=dev --env-interface CloudflareEnv ./src/types/worker-configuration.d.ts` (hash: 33f6259e1530368b13cea663d00d82a6)
// Runtime types generated with workerd@1.20250508.0 2025-05-14 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ACCESS_CODES_DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* access-codes-map */;
		ASSETS: Fetcher;
	}
}
