/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=dev --env-interface CloudflareEnv ./src/types/worker-configuration.d.ts` (hash: 4cc687634cea0132ef87ccad08b9c6b4)
